...
const CompanyProfile: React.FC<CompanyProfileProps> = ({ 
  ...
  const text = {
    ar: {
      ...
      claimCompanyDescription: 'لطلب ملكية هذه الشركة، يرجى تقديم عنوان بريد إلكتروني للموظف والمشرف باستخدام نطاق الشركة.',
      employeeEmail: 'البريد الإلكتروني للموظف',
      supervisorEmail: 'البريد الإلكتروني للمشرف',
      employeeUsernamePlaceholder: 'اسم المستخدم',
      supervisorUsernamePlaceholder: 'اسم المستخدم',
      ...
      claimError: 'حدث خطأ أثناء إرسال طلب الملكية'
    },
    en: {
      loading: 'Loading...',
      ...
      claimCompanyDescription: 'To claim this company, please provide employee and supervisor email addresses using the company domain.',
      employeeEmail: 'Employee Email',
      supervisorEmail: 'Supervisor Email',
      employeeUsernamePlaceholder: 'Username',
      supervisorUsernamePlaceholder: 'Username',
      ...
      claimError: 'Error submitting claim request'
    }
  };
  ...
  useEffect(() => {
    const fetchCompanyData = async () => {
      ...
      try {
        ...
        // Extract domain for claim functionality
        let domain = '';
  ...
  const handleClaimSubmit = async () => {
    ...
    try {
      ...
      toast.error(error.message || text[language].claimError);
    } finally {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              {text[language].claimCompanyDescription}
            </p>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-primary-500 focus-within:border-primary-500 transition-all duration-200">
                  <input
                    type="text"
                    ...
                    className="flex-1 px-3 py-3 border-0 focus:outline-none focus:ring-0"
                    dir={language === 'ar' ? 'rtl' : 'ltr'}
                    disabled={submittingClaim}
                  />
                  <span 
                    className="px-3 py-3 bg-gray-100 text-gray-700 border-0 flex items-center text-sm font-mono"
                    dir="ltr"
                  >
                    @{companyDomain}
                  </span>
            ...
            <div className="flex space-x-3 rtl:space-x-reverse mt-6">
              ...
              <button
                ...
                disabled={submittingClaim || !claimFormData.employeeUsername.trim() || !claimFormData.supervisorUsername.trim()}
