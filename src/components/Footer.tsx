...
const Footer: React.FC<FooterProps> = ({ language, onNavigate }) => {
  const text = {
    ar: {
      ...
      followUs: 'تابعنا',
      description: 'R8 Estate هي منصة التقييم الرائدة للقطاع العقاري في مصر. نساعد العملاء في العثور علي أفضل الشركات العقارية الموثوقة.',
    ...
    en: {
      ...
      followUs: 'Follow Us',
      description: 'R8 Estate is the leading review platform for the real estate sector in Egypt. We help customers find the best trusted real estate companies.',
      email: 'info@r8estate.com',
      phone: '+20 123 456 7890',
      address: 'Cairo, Egypt',
